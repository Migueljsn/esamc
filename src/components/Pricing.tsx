...
const INCLUSIONS = [
  "Atendimento da Educação Infantil ao Ensino Médio",
  "Professores dedicados a cada etapa de ensino",
  "Acompanhamento pedagógico próximo à família",
  "Tradição de mais de 40 anos em Teresina",
  "Histórico consistente de aprovação em universidades",
  "Condições de matrícula sob consulta com a secretaria",
];
    ...
    <section ref={sectionRef} id="inscricao" className="py-24 md:py-36 px-6 max-w-4xl mx-auto">
      ...
      <div className="text-center mb-16">
        ...
        <div className="overflow-hidden">
          {["Condições feitas para a sua família"].map((line, i) => (
        ...
        <div className="grid md:grid-cols-2 gap-0">
          ...
          <div className="flex flex-col items-center justify-center p-12 text-center border-b md:border-b-0 md:border-r border-border">
            ...
            <div className="flex items-start gap-2">
              <span className="font-display text-3xl md:text-4xl font-extrabold leading-none text-text">Sob consulta</span>
            </div>
            <p className="text-muted text-sm mt-3 max-w-[220px]">Valor varia conforme o segmento e a série do aluno</p>
