...
const INCLUSIONS = [
  ...
  "Atendimento pelo WhatsApp: (86) 8879-6879",
];
...
export function ScholarshipInfo() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.from(".scholarship-title-line", {
        y: "110%",
        duration: 1.0,
        stagger: 0.2,
        ease: "power3.out",
  ...
  return (
    <section ref={sectionRef} id="inscricao" className="py-24 md:py-36 px-6 max-w-4xl mx-auto">
      ...
      <div className="text-center mb-16">
        <div className="scholarship-label flex items-center justify-center gap-2 mb-6 text-accent-light text-sm tracking-widest uppercase font-sans">
        ...
        <div className="overflow-hidden">
          {["Como funciona o Teste Bolsa"].map((line, i) => (
            <div key={i} className="clip-reveal">
              <h2 className="scholarship-title-line font-display text-[clamp(2rem,5vw,4rem)] font-extrabold text-text">
                {line}
              </h2>
            </div>
          ))}
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-0">
          ...
          <div className="flex flex-col items-center justify-center p-12 text-center border-b md:border-b-0 md:border-r border-border">
            <p className="text-muted text-sm uppercase tracking-widest mb-4 font-sans">Bolsa de até</p>
            ...
            <p className="text-muted/60 text-xs mt-4">Fale com a secretaria pelo WhatsApp</p>
          </div>

          {/* Inclusions side */}
          <div className="p-12">
            <p className="font-display font-semibold text-text mb-8 text-lg">O que você precisa saber:</p>
