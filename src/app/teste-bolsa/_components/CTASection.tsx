...
export function CTASection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.from(".cta-title-line", { y: "110%", duration: 1.0, stagger: 0.2 })
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <div className="font-display text-[clamp(2.5rem,7vw,6rem)] font-extrabold leading-tight mb-8">
          {["Pronto para testar", "sua bolsa?"].map((line, i) => (
        ...
        <p className="cta-sub text-muted text-lg max-w-xl mx-auto leading-relaxed mb-12">
          Agende o Teste Bolsa do dia 26 de setembro e dê ao seu filho ou filha a chance de estudar na Escola Santa Angélica com uma bolsa de até 100%.
        </p>
