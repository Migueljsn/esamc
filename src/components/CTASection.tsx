    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <div className="font-display text-[clamp(2.5rem,7vw,6rem)] font-extrabold leading-tight mb-8">
          {["Pronto para", "matricular?"].map((line, i) => (
        ...
        <p className="cta-sub text-muted text-lg max-w-xl mx-auto leading-relaxed mb-12">
          Garanta a vaga do seu filho ou filha na Escola Santa Angélica e comece uma jornada de mais de 40 anos de tradição com quem mais entende de educação em Teresina.
        </p>
