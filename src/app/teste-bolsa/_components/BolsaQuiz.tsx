        ...
        return (
          <div className="text-center">
            ...
            <h2 className="font-display text-3xl md:text-4xl font-extrabold text-text mb-3">
              Vamos agendar seu Teste Bolsa
            </h2>
            <p className="text-muted max-w-sm mx-auto mb-10 leading-relaxed">
              Rápido e fácil — algumas perguntas para confirmar sua vaga no dia 26 de setembro.
            </p>
      ...
      case 1:
        return (
          <StepLayout
            ...
            hint="Você é o responsável pela inscrição — nossa equipe vai falar com você"
            error={error}
          >
            <input
              autoFocus
      ...
      case 3:
        return (
          <StepLayout
            ...
            hint="Para enviarmos os detalhes do Teste Bolsa"
            error={error}
          >
            <input
              autoFocus
      ...
      case 6:
        return (
          <StepLayout
            ...
            hint="Assim já deixamos tudo pronto para o dia do teste"
            error={error}
          >
            <input
              autoFocus
        ...
        return (
          <div className="text-center">
            ...
            <p className="text-muted max-w-sm mx-auto mb-10 leading-relaxed">
              ...
              {" "}para confirmar sua inscrição no Teste Bolsa.
            </p>
            <button
